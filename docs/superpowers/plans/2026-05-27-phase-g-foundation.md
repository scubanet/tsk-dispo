...
-- Test 1+2: Alice sieht nur ihr Event
...
-- Test 3+4: Bob sieht nur sein Event
RESET role;
...
Expected: `ok 1 - Alice sees her own event` ... 4 ok. Falls eine fehlschlägt: zurück zu Migration 0111, RLS-Definition prüfen.
