...
describe('PropertiesSidebar', () => {
  it('renders display name + 6 always-on stubs + PADI stub (when instructor sidecar present)', async () => {
    ...
    expect(screen.getByTestId('section-stub-contact')).toBeTruthy()
    expect(screen.getByTestId('section-stub-roles')).toBeTruthy()
    expect(screen.getByTestId('section-stub-org')).toBeTruthy()
