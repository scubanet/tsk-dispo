...
//
// Phase G Phase 3 Task 11 — PadiSection: PADI-Level / Pro-Nummer.
...
// Member-Status: Spalte existiert auf Prod nicht (Repo-Schema-Drift in
// Migration 0091). Aktiv-Flag wird in RolesStatusSection als Toggle gerendert.
