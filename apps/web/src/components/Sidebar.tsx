...
const ITEMS: NavItem[] = [
  ...
  { to: '/shop',              icon: 'tag',      i18nKey: 'shop',            roles: ['dispatcher', 'owner', 'cd'] },
  { to: '/kasse',             icon: 'wallet',   i18nKey: 'pos',             roles: ['dispatcher', 'owner', 'cd'] },
  { to: '/verleih',           icon: 'water',    i18nKey: 'rental',          roles: ['dispatcher', 'owner', 'cd'] },
  { to: '/trips',             icon: 'calendar', i18nKey: 'trips',           roles: ['dispatcher', 'owner', 'cd'] },
